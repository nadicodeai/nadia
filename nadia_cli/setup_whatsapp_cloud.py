...
Entry point: ``nadia whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``nadia_cli/main.py``).
...
Nadia gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Nadia to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Nadia needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Nadia gateway in another terminal:")
    print("         nadia gateway")
    print()
    ...
    print()
    print("  Docs: https://docs.nadicode.ai/nadia/user-guide/")
