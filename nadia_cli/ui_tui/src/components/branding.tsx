import { Box, Text, useStdout } from '@nadia/ink'
...
const TAG_FULL = 'Nadia Agent by NadicodeAI'
const TAG_MID = 'Nadia Agent'
const TAG_TINY = 'Nadia'
const HIDE_BELOW = 34
...
export function SessionPanel({ info, maxWidth, sid, t }: SessionPanelProps) {
  ...
  // nadia_cli/banner.py) and the "connected" label on the collapse toggle.
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · NadicodeAI</Text>
          </Text>
      ...
      <Box flexDirection="column" width={w}>
        ...
        {typeof info.update_behind === 'number' && info.update_behind > 0 && (
          <Text bold color={t.color.warn}>
            ...
            <Text bold color={t.color.warn}>
              {info.update_command || 'nadia update'}
            </Text>
            <Text bold={false} color={t.color.warn} dimColor>
              {' '}
              to update
