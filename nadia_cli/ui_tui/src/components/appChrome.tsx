import { Box, type ScrollBoxHandle, stringWidth, Text } from '@nadia/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (NADIA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (NADIA_DEV_CREDITS), lowest priority,
