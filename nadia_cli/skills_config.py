"""
Skills configuration for Nadia Agent.
`nadia skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.nadia/config.yaml under:
...
from nadia_cli.config import cfg_get, load_config, save_config
from nadia_cli.colors import Colors, color
from nadia_cli.platforms import PLATFORMS as _PLATFORMS
