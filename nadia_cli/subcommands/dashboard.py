"""``nadia dashboard`` subcommand parser.
...
def build_dashboard_parser(
    ...
    # for `nadia dashboard` cmdlines and SIGTERM them directly — the same
    # path `nadia update` uses to clean up stale dashboards.
    dashboard_parser.add_argument(
        "--stop",
        action="store_true",
        help="Stop all running nadia dashboard processes and exit",
    )
    dashboard_parser.add_argument(
        "--status",
        action="store_true",
        help="List running nadia dashboard processes and exit",
    )
