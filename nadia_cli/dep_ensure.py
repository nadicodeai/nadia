...
def _has_nadia_agent_browser() -> bool:
    ...
    # install.sh installs globally into $NADIA_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-NadiaHome", str(get_nadia_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = nadia_subprocess_env(inherit_credentials=False)
