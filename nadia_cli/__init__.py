"""
Nadia CLI - Unified command-line interface for Nadia Agent.

Provides subcommands for:
- nadia chat          - Interactive chat (same as ./nadia)
- nadia gateway       - Run gateway in foreground
- nadia gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `nadia setup` on a fresh Pi.
    ...
    nadia_cli/stdio.py::configure_windows_stdio() runs later from the entry
