...
Invoked by ``nadia kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Nadia Agent board.
...
def _profile_author() -> str:
    """Mirror of ``nadia_cli.kanban._profile_author``."""
    return (
