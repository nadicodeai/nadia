...
Usage:
    nadia pairing list              # Show all pending + approved users
    nadia pairing approve <platform> <code>  # Approve a pairing code
    nadia pairing revoke <platform> <user_id> # Revoke user access
    nadia pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle nadia pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: nadia pairing {list|approve|revoke|clear-pending}")
        print("Run 'nadia pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.nadia/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'nadia pairing list' to see pending codes.\n")
