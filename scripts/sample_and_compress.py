...
DEFAULT_DATASETS = [
    "NadicodeAI/swe-terminus-agent-glm-kimi-minimax",
    "NadicodeAI/nadia-megascience-sft1",
    "NadicodeAI/Nadia-Agent-Thinking-GLM-4.7-SFT2",
    "NadicodeAI/Nadia-Agent-Thinking-GLM-4.7-SFT1",
    "NadicodeAI/terminal-tasks-glm-nadia"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "NadicodeAI/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload NadicodeAI/{output_name} {final_output}")
