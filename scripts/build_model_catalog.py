#!/usr/bin/env python3
"""Build the Nadia Model Catalog — a centralized JSON manifest of curated models.
...
Nadia CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Nadia release.
...
# Ensure NADIA_HOME is set for imports that touch it at module level.
os.environ.setdefault("NADIA_HOME", os.path.join(os.path.expanduser("~"), ".nadia"))

from nadia_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "nadia-agent repo",
            "docs": "https://docs.nadicode.ai/nadia/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
