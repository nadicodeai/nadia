#!/usr/bin/env python3
"""Build the Nadia Skills Index — a centralized JSON catalog of all skills.
...
`nadia skills search/install` can use it without hitting the GitHub API.
...
# Ensure NADIA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Nadia Skills Index...", flush=True)
