...
#
# See: https://github.com/nadicodeai/nadia/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Nadia) run before
    ...
    if status_code == 404:
        # Nadia API currently surfaces HA/NAS credit depletion as a paid model
