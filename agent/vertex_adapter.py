"""Vertex AI (Google Cloud) adapter for Nadia Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Nadia to use Gemini models via Google Cloud with
...
# who installed plain `nadia-agent` and only later selected a Gemini model.
try:
