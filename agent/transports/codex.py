...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Nadia's web-provider config and
        ...
        # native search engine for xAI sessions instead of Nadia's
        # configured web provider (Tavily/etc.), and those results bypass
        # Nadia's tool-trace / citation plumbing (they arrive baked into the
