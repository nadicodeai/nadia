...
class NadiaACPAgent(acp.Agent):
    ...
    async def prompt(
        ...
        **kwargs: Any,
        ...
        # not the executor's. Also set NADIA_INTERACTIVE so approval.py
        ...
        def _run_agent() -> dict:
            ...
            previous_interactive = os.environ.get("NADIA_INTERACTIVE")
            ...
            try:
                ...
                # Restore NADIA_INTERACTIVE.
                if previous_interactive is None:
                    os.environ.pop("NADIA_INTERACTIVE", None)
                else:
                    os.environ["NADIA_INTERACTIVE"] = previous_interactive
