...
_LONG_HANDLERS = frozenset(
    {
        ...
        "complete.slash",
        "llm.oneshot",
        # Python pet RPCs removed from worker-pool routing.
        "learning.frames",
        "plugins.manage",
        "process.list",
...
# Pet-only RPC profile wrapper removed.
...
# Python pet gateway RPC handlers and staged-generation cleanup removed.
