...
def _persist_model_switch(result) -> None:
    from nadia_cli.config import save_config
...
def _apply_model_switch(
    ...
    *,
    ...
    from nadia_cli.model_switch import parse_model_flags, switch_model
...
def _make_agent(
    ...
    if isinstance(model_override, dict) and model_override.get("model"):
        ...
        if (
            ...
            from nadia_cli.runtime_provider import find_custom_provider_identity
