...
const STORAGE_KEY = "nadia-dashboard-theme";
...
const FONT_STORAGE_KEY = "nadia-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + Nadia-blue rebrand.
  "lens-5i": "nadia-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `nadia_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "nadia-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-nadia-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-nadia-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Nadia Blue) doesn't leave its values behind when the user
