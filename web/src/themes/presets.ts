 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `nadia_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Nadia Teal",
  description: "Classic dark teal — the canonical Nadia look",
  palette: {
...
/**
 * Nadia Blue — the inverted "light mode" Nadia look, ported from the
 ...
 * the orange midground reads as #0053FD Nadia-blue on screen, against a
 * cream `#E8F2FD` canvas.
 *
 * Note on bg blend mode: the DS Lens uses `multiply` for LENS_5I because
 * nousnet-web's <body> is white; nadia-agent's App root is `bg-black`,
 ...
 */
export const nadiaBlueTheme: DashboardTheme = {
  name: "nadia-blue",
  label: "Nadia Blue",
  description: "Light mode — vivid Nadia-blue accents on cream canvas",
  palette: {
  ...
  // bright Nadia-blue canvas — the coral is the "red" users see for
  // Output values without these overrides. Source → on-screen:
  //   Input:  #ffe6cb → #001934 (dark navy)        ← unchanged
  //   Output: #ffac02 → #0053fd (vivid Nadia-blue)  ← brand accent
  ...
  // Nadia-blue so the "primary" series in token-flow charts reads as
  ...
  //   white → vivid Nadia-blue → cream/light-blue
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Nadia Teal (Large)",
  description: "Nadia Teal with bigger fonts and roomier spacing",
