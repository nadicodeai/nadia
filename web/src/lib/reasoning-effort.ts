 ...
 *
 * Values mirror nadia_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Nadia default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Nadia's default when unset). */
