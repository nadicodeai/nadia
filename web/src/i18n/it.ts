...
export const it: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Nadia (parità con `nadia plugins`).",
  ...
  env: {
    ...
    customHint: "Variabili d'ambiente arbitrarie salvate nel tuo .env che Nadia non riconosce. Usale per iniettare variabili d'ambiente per skill, server MCP o i tuoi strumenti.",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Nadia di più",
