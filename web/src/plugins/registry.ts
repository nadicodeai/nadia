 ...
 *
 * Plugins call window.__NADIA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__NADIA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__NADIA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__NADIA_PLUGIN_SDK__ = {
    ...
    // window.__NADIA_SESSION_TOKEN__ directly.
    authedFetch,
