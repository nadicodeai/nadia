...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$NADIA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_nadia_dir("platforms/whatsapp/session", "whatsapp/session")
