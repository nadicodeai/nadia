...
required — uses aiohttp which is already a Nadia dependency.
...
def interactive_setup() -> None:
    ...
    ``nadia_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Nadia delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # nadia_cli/setup.py::_setup_mattermost function.
