...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Nadia gateway adapter.

    Each inbound phone number gets its own Nadia session (multi-tenant).
...
# static dict in nadia_cli/gateway.py, and the _send_sms dispatch in
