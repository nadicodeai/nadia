...
Env vars::
    ...
    FIRECRAWL_GATEWAY_URL=...        # Nadia tool-gateway (subscribers)
...
def _is_tool_gateway_ready() -> bool:
    """Return True when gateway URL + Nadia Subscriber token are available.
...
def check_firecrawl_api_key() -> bool:
    ...
    existing tests and the ``nadia tools`` setup flow.
    """
