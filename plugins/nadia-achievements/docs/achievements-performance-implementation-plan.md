# Nadia Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.nadia/plugins/nadia-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.nadia/plugins/nadia-achievements/scan_checkpoint.json`.
