# Nadia Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.nadia/plugins/nadia-achievements/state.json` (existing unlock state)
  - `~/.nadia/plugins/nadia-achievements/scan_snapshot.json` (new)
  - `~/.nadia/plugins/nadia-achievements/scan_checkpoint.json` (new)
