...
``_check_spotify_available()`` — when the user has not run ``nadia auth
spotify``, the tools remain registered (so they appear in ``nadia
...
The Spotify auth flow (``nadia auth spotify``), CLI plumbing, and docs
