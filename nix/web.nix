# nix/web.nix — Nadia Web Dashboard (Vite/React) frontend build
{ pkgs, nadiaNpmLib, ... }:
let
  npm = nadiaNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "nadia-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../nadia_cli/web_dist for the
