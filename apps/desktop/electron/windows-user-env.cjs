...
// even though a fresh shell — and the Nadia CLI — sees it immediately. The
// desktop's NADIA_HOME resolution relies on process.env, so that stale-snapshot
...
//       NADIA_HOME    REG_SZ    F:\Nadia\data
//
