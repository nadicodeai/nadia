 ...
 *
 * A public install can end up with `origin=git@github.com:nadicodeai/nadia.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/nadicodeai/nadia.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nadicodeai/nadia'
