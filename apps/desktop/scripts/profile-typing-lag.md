...
cd apps/desktop
XCURSOR_SIZE=24 NADIA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/nadia-typing
# → /tmp/nadia-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/nadia-typing.before.heapsnapshot
# → /tmp/nadia-typing.after.heapsnapshot
```
