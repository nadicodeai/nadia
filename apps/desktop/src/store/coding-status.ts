...
import type { NadiaGitWorktree, NadiaRepoStatus } from '@/global'
...
export const $repoStatus = atom<NadiaRepoStatus | null>(null)
...
export const $repoWorktrees = atom<NadiaGitWorktree[]>([])
