...
export interface PetInfo {
  ...
  // the Nadia "run" activity state uses the in-place running row).
 ...
 * NADIA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'nadia.desktop.pet-roam.v1'
