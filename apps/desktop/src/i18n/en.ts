...
export const en: Translations = {
  ...
  boot: {
    ready: 'Nadia Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Nadia settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingNadiaDesktop: 'Starting Nadia Desktop…'
    },
    errors: {
      backgroundExited: 'Nadia background process exited.',
      backgroundExitedDuringStartup: 'Nadia background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Nadia backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Nadia Desktop.',
    ...
    native: {
      ...
      inputBody: 'Nadia is waiting for your response.',
      turnDoneTitle: 'Nadia finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Nadia defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Nadia is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Nadia asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Nadia was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Nadia checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Nadia configuration...',
  ...
  starmap: {
    ...
    emptyDesc: 'As Nadia builds skills and memories for your work, they appear here.',
    share: 'Share map',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Nadia desktop' },
    ...
    nadiaActiveSessions: (version, count) => `Nadia ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@nadia:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Nadia environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Nadia will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Nadia backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Nadia. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Nadia...',
    placeholderReconnecting: 'Reconnecting to Nadia…',
    ...
    attachUrlDesc: 'Nadia will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Nadia to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Nadia…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Nadia…',
    ...
    unsupportedMessage: 'This version of Nadia can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Nadia from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Nadia will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Nadia desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Nadia updater takes over in its own window and reopens Nadia automatically when it’s done. Please don’t reopen Nadia yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Nadia reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Nadia reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Nadia needs a one-time install',
    ...
    settingUpTitle: 'Setting up Nadia Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Nadia CLI or desktop instance is running. Stop any running Nadia instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Nadia Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Nadia is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Nadia…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Nadia',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Nadia at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Nadia connects automatically',
      loopback: 'Opens your browser to sign in — Nadia connects automatically',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Nadia there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Nadia inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Nadia will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Nadia is restarting...',
      askRestart: 'Ask Nadia to restart the server',
      lookingRestart: taskId => `Nadia is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Nadia is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Nadia finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Nadia could not restart the server.',
      stillWorking:
        'Nadia is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nadia is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Nadia gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.nadia/config.yaml). Nadia won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Nadia needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Nadia needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Nadia Desktop to use Save Image.',
    restartToSaveImages: 'Restart Nadia Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `nadia gateway` running?'
    }
  },
