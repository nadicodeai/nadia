...
export const en: Translations = {
  ...
  settings: {
    ...
    providers: {
      ...
      removeExternal: (provider, command) => `${provider} is managed outside Nadia. Remove it with ${command}.`,
  ...
  updates: {
    ...
    applyingBody: 'The Nadia updater will take over in its own window and reopen Nadia when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Nadia reconnects automatically when it’s back.',
    applyingClose: 'Nadia will close to apply the update.',
