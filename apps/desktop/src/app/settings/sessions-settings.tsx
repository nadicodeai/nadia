...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/nadia'
...
// / Program Files), which buried any files Nadia wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.nadiaDesktop` is
    ...
    const settings = window.nadiaDesktop?.settings
