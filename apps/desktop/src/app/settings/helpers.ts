import type { NadiaConfigRecord, ToolsetInfo } from '@/types/nadia'
...
export function getNested(obj: NadiaConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: NadiaConfigRecord, path: string, value: unknown): NadiaConfigRecord {
...
function personalityOptions(config: NadiaConfigRecord): string[] {
