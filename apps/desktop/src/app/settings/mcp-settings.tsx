...
import { getNadiaConfigRecord, type NadiaGateway, saveNadiaConfig } from '@/nadia'
...
function getServers(config: NadiaConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveNadiaConfig(nextConfig)
