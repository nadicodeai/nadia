...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/nadia'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('nadia:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('nadia:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Nadia to
...
interface SidebarSessionsSectionProps {
  ...
  projectRepoWorktrees?: Record<string, NadiaGitWorktree[]>
