...
import type { SessionInfo } from '@/nadia'
 ...
 * e.g. `nadia-agent/desktop` vs `nadia-agent-wt-rtl/desktop`. Groups with a
...
export type WorktreeResolver = (cwd: string) => NadiaWorktreeInfo | null | undefined
