...
import type { ProjectInfo, SessionInfo } from '@/nadia'
 ...
 * repo shows its branches/worktrees even when they have no Nadia sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: NadiaGitWorktree[]
): SidebarSessionGroup[] {
