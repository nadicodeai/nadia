...
const FOCUS_EVENT = 'nadia:composer-focus'
const INSERT_EVENT = 'nadia:composer-insert'
const INSERT_REFS_EVENT = 'nadia:composer-insert-refs'
const SUBMIT_EVENT = 'nadia:composer-submit'
const VOICE_TOGGLE_EVENT = 'nadia:composer-voice-toggle'
