...
const TAKEOVER_KEY = 'nadia.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Nadia can't clear via the API — the user
 *  sees exactly what runs instead of Nadia silently deleting their creds. */
