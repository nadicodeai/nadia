import type { NadiaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: NadiaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: NadiaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
