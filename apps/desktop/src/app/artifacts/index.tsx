...
import { getSessionMessages, listAllProfileSessions } from '@/nadia'
...
import type { SessionInfo, SessionMessage } from '@/types/nadia'
    ...
    async (href: string) => {
      try {
        if (window.nadiaDesktop?.openExternal) {
          await window.nadiaDesktop.openExternal(href)
        } else {
