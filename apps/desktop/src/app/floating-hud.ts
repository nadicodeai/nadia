...
// hairline `--stroke-nadia` paired with the soft `--shadow-nadia` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-nadia) bg-(--ui-chat-bubble-background) shadow-nadia [-webkit-app-region:no-drag]'
