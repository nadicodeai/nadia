...
const NADIA_BLUE = '#0053FD'
const PSYCHE_BLUE = '#1540B1'
const PSYCHE_WARM = '#FFE6CB'

const nadiaTint = (pct: number) => `color-mix(in srgb, ${NADIA_BLUE} ${pct}%, #FFFFFF)`
const nadiaTintTransparent = (pct: number) => `color-mix(in srgb, ${NADIA_BLUE} ${pct}%, transparent)`

/**
 * Nadia — canonical Nadia desktop identity. The palette keeps the current
...
export const nadiaTheme: DesktopTheme = {
  name: 'nadia',
  label: 'Nadia',
  description: 'Glass neutrals with Nadia blue accents',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
    ...
    secondary: nadiaTint(7),
    secondaryForeground: '#242432',
    accent: nadiaTint(10),
    accentForeground: '#202030',
    border: nadiaTintTransparent(22),
    input: nadiaTintTransparent(30),
    ring: NADIA_BLUE,
    midground: NADIA_BLUE,
    composerRing: NADIA_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: nadiaTintTransparent(18),
    userBubble: nadiaTint(6),
    userBubbleBorder: nadiaTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
