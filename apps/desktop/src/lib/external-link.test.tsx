...
const desktopWindow = window as unknown as { nadiaDesktop?: Window['nadiaDesktop'] }
const initialNadiaDesktop = desktopWindow.nadiaDesktop

function installDesktopBridge(partial: Partial<Window['nadiaDesktop']> = {}) {
  desktopWindow.nadiaDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['nadiaDesktop']
}
...
afterEach(() => {
  ...
  if (initialNadiaDesktop) {
    desktopWindow.nadiaDesktop = initialNadiaDesktop
  } else {
    delete desktopWindow.nadiaDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['nadiaDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['nadiaDesktop']['openExternal'] })
