...
import type { ModelOptionProvider, ModelOptionsResponse, ModelPricing } from '@/types/nadia'
...
export function ModelPickerDialog({
  ...
  // the `nadia model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for Nadia. true → "Free tier", false → "Pro".
  const tierBadge =
