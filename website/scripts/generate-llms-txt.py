#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Nadia docs site.
...
Both publish at:
  https://docs.nadicode.ai/nadia/llms.txt
  https://docs.nadicode.ai/nadia/llms-full.txt
...
SITE_BASE = "https://docs.nadicode.ai/nadia"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Nadia as a Python Library", None),
        ("guides/use-mcp-with-nadia", "Use MCP with Nadia", None),
        ("guides/use-voice-mode-with-nadia", "Use Voice Mode with Nadia", None),
        ("guides/use-soul-with-nadia", "Use SOUL.md with Nadia", None),
        ("guides/build-a-nadia-plugin", "Build a Nadia Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Nadia"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Nadia Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by NadicodeAI. A terminal-native "
    ...
    lines.append("")
    lines.append("Repo: https://github.com/nadicodeai/nadia")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        (
            ...
            "Started, Using Nadia, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://docs.nadicode.ai/nadia\n",
        "Short index: https://docs.nadicode.ai/nadia/llms.txt\n",
        "\n---\n\n",
    ]
