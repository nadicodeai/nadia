...
| Related skills | [`codex`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`nadia-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nadia-agent), [`opencode`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-opencode) |
