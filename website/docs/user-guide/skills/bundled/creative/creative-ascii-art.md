...
```bash
python3 -m pyfiglet "NADIA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=NADIA&font=Slant" | boxes -d stone
```
