...
| | |
|---|---|
| Source | Optional — install with `nadia skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Nadia Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $NADIA_OSINT_CACHE/icij/ (default: ~/.cache/nadia-osint/icij/).
...
# Set NADIA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
