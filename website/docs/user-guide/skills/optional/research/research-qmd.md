...
| | |
|---|---|
| Source | Optional — install with `nadia skills install official/research/qmd` |
...
Nadia Agent via the native MCP client. This is the preferred
...
Then configure Nadia Agent to connect via HTTP:
