...
| | |
|---|---|
| Source | Optional — install with `nadia skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Nadia Agent |
| License | MIT |
...
The script reads `${NADIA_HOME:-~/.nadia}/.env` for two optional defaults:
...
Helper script: `~/.nadia/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.nadia/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${NADIA_HOME:-~/.nadia}/.env`.
...
```bash
python3 ~/.nadia/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.nadia/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
