...
| | |
|---|---|
| Source | Optional — install with `nadia skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Nadia Agent |
| License | MIT |
...
Helper script path: `~/.nadia/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.nadia/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.nadia/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.nadia/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
