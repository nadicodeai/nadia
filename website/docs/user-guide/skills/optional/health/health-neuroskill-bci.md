...
| | |
|---|---|
| Source | Optional — install with `nadia skills install official/health/neuroskill-bci` |
...
Connect Nadia to a running [NeuroSkill](https://neuroskill.com/) instance to read
