...
| | |
|---|---|
| Source | Optional — install with `nadia skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Nadia Agent |
| License | MIT |
...
```
SCRIPT=~/.nadia/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.nadia/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
