...
| | |
|---|---|
| Source | Optional — install with `nadia skills install official/gaming/pokemon-player` |
...
The repo is `github.com/NadicodeAI/pokemon-agent` on GitHub. Clone it, then
