...
:::tip
Traffic routed through [NadicodeAI Portal](/integrations/nadia-portal) still respects per-model routing and priority configs — and Portal subscribers get 10% off token-billed providers.
:::
