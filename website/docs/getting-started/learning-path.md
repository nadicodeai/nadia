...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Nadia Agent documentation based on your experience level and goals.'
---

# Learning Path

Nadia Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Nadia Agent yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Nadia Agent can do.
...
Use Nadia Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Nadia Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Nadia Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Nadia](/guides/use-voice-mode-with-nadia)
...
:::tip
Cron jobs let Nadia Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Nadia Agent with your own tools and reusable skill packages.

1. [Plugins](/user-guide/features/plugins)
2. [Build a Nadia Plugin](/guides/build-a-nadia-plugin)
...
page is for built-in Nadia core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Nadia Agent's RL training pipeline (powered by Atropos (wire reference: `github.com/NadicodeAI/atropos`)).

1. [Quickstart](/getting-started/quickstart)
2. [Configuration](/user-guide/configuration)
3. Atropos RL Environments (external, wire reference: `github.com/NadicodeAI/atropos`)
4. [Provider Routing](/user-guide/features/provider-routing)
5. [Architecture](/developer-guide/architecture)

:::tip
RL training works best when you already understand the basics of how Nadia Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Nadia Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Nadia tools programmatically | [Code Execution](/user-guide/features/code-execution) |
