...
4. From then on, Nadia refreshes the access token in the background — you stay signed in until you `nadia auth remove xai-oauth` or revoke access from your xAI account settings.
...
```bash
nadia config set model.default grok-4.3
