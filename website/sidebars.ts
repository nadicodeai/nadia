  ...
  docs: [
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            // Python pet feature docs removed.
            ...
            'reference/optional-skills-catalog',
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-nadia-agent-skill-authoring',
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/optional/devops/devops-nadia-s6-container-supervision',
    ...
    },
    {
      ...
      items: [
        ...
        'guides/run-nadia-with-nadia-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-nadia',
        'guides/use-soul-with-nadia',
        'guides/use-voice-mode-with-nadia',
