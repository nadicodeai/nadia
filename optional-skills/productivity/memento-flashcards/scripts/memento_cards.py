...
Data file: $NADIA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NADIA_HOME = Path(os.environ.get("NADIA_HOME", Path.home() / ".nadia"))
DATA_DIR = _NADIA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
