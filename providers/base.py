...
def _profile_user_agent() -> str:
    """Return a ``nadia-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from nadia_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"nadia-cli/{_ver}"
    except Exception:
        return "nadia-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # nadia-cli UA so the catalog endpoint is reachable.
