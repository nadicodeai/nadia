...
Built for [Nadia Agent](https://github.com/nadicodeai/nadia). Usable in any coding agent. Canonical source lives here; synced to [`nadicodeai/nadia/skills/creative/ascii-video`](https://github.com/nadicodeai/nadia/tree/main/skills/creative/ascii-video) via PR.
